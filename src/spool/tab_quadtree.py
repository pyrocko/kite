...
class QKiteQuadtreePlot(QKitePlot):
    def __init__(self, scene_proxy):
        ...
        self.scene_proxy.evQuadtreeChanged.subscribe(self.update)
        self.scene_proxy.evQuadtreeChanged.subscribe(self.updateFocalPoints)
        # self.scene_proxy.evFrameChanged.subscribe(self.transFromFrame)
        # self.scene_proxy.evFrameChanged.subscribe(self.transFromFrameScatter)
...
class QKiteParamQuadtree(QKiteParameterGroup):
    def __init__(self, scene_proxy, plot, *args, **kwargs):
        ...
        scene_proxy.evQuadtreeConfigChanged.subscribe(self.onConfigUpdate)
        scene_proxy.evQuadtreeChanged.subscribe(self.updateValues)

        QKiteParameterGroup.__init__(self,
                                     model=scene_proxy.quadtree,
                                     model_attr='quadtree',
                                     **kwargs)
